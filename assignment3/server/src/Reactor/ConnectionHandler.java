...
public class ConnectionHandler<T> {
	...
	protected AsyncServerProtocol<T> _protocol;
	protected final AsyncServerProtocol<T> baseProtocol;
	...
	private ConnectionHandler(SocketChannel sChannel, ReactorData<T> data, SelectionKey key) {
		_sChannel = sChannel;
		_data = data;
		baseProtocol=(AsyncServerProtocol)(_data.getProtocolMaker().create());
	...
	public void setProtocol(ServerProtocol protocol) {
		this._protocol=(AsyncServerProtocol)(protocol);
	}
